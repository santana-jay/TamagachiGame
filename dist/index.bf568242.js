...
const gameState = {
    ...
    wake () {
        ...
        (0, _ui.writeModal)("I'M ALIVE!");
        setTimeout((0, _ui.writeModal), 3000);
    },
    sleep () {
        this.state = "SLEEP";
        (0, _ui.modFox)("sleep");
    ...
    getHungry () {
        ...
        this.hungryTime = -1;
        (0, _ui.modFox)("hungry");
        (0, _ui.writeModal)("I'm Hungry Emery. Can I have some food please?");
    },
    die () {
        this.current = "DEAD", (0, _ui.modScene)("dead");
        (0, _ui.modFox)("dead");
        this.clearTimes();
        (0, _ui.writeModal)(`Oh no Emery!! The fox died :,( <br/> Press the middle button to start a new game.`);
    },
    startCelebrating () {
        (0, _ui.writeModal)();
...
},{"./constants":"3huJa","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6xLNB","hBLPf"], "hBLPf", "parcelRequire1634")
